...
app.use(express.static('technician-frontend/build')); // Assuming your React build is in a directory named 'build'
...
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, 'technician-frontend/build', 'index.html'));
});
