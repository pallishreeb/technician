...
import { TechnicianModal, TechnicianTable } from "../components";
    ...
    <>
      {openModal && (
        <TechnicianModal
          ...
          modal={openModal}
          setTechnicianToUpdate={setTechnicianToUpdate}
          technicianToUpdate={technicianToUpdate}
        />
      )}
      {openDeleteModal && (
        <DeleteModal
          setModal={setDeleteModal}
          itemToDelete={technicianToDelete}
          setItemToDelete={setTechnicianToDelete}
          itemType={"technician"}
        />
      )}
