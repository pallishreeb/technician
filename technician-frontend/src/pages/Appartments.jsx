...
import { AppartmentTable, AppartmentModal } from "../components";
    ...
    <>
      {openModal && (
        <AppartmentModal
          ...
          modal={openModal}
          setAppartmentToUpdate={setAppartmentToUpdate}
          appartmentToUpdate={appartmentToUpdate}
        />
      )}
      {openDeleteModal && (
        <DeleteModal
          setModal={setDeleteModal}
          itemToDelete={appartmentToDelete}
          setItemToDelete={setAppartmentToDelete}
          itemType={"apartment"}
        />
      )}
      ...
      <div className="w-full bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
        ...
        <AppartmentTable
          ...
          setModal={setopenModal}
          setAppartmentToUpdate={setAppartmentToUpdate}
          setAppartmentToDelete={setAppartmentToDelete}
        />
      </div>
    </>
  );
